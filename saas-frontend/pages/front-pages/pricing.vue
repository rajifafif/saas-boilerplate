...
const faqs = [
  {
    question: 'How do I start a workspace trial?',
    answer: 'Create an account, invite your team, and configure your first organization workspace. Billing setup can be connected later when your SaaS is production-ready.',
  },
  {
    question: 'What counts towards the 100 responses limit?',
    answer: 'We count all form submissions received across your workspace in a month. The counter resets at the start of the next billing cycle.',
  },
  {
    question: 'Can I change plans later?',
    answer: 'Yes. Start with the smallest plan that fits your team and upgrade when you need more seats, organizations, branches, or audit history.',
  },
]
</script>
