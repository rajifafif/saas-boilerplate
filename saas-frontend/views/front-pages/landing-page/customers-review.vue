...
const reviewData = [
  {
    desc: 'I\'ve never used a theme as versatile and flexible as SaaS Boilerplate. It\'s my go to for building dashboard sites on almost any project.',
    img: logo1,
    rating: 5,
    name: 'Eugenia Moore',
  ...
  {
    desc: 'This template is superior in so many ways. The code, the design, the regular updates, and the support are excellent.',
    img: logo3,
    rating: 4,
    name: 'Eugenia Moore',
  ...
  {
    desc: 'SaaS Boilerplate is awesome, and I particularly enjoy knowing that if I get stuck on something, there is always a helpful community to assist me.',
    img: logo3,
    rating: 5,
    name: 'Tommy haffman',
                        ...
                        <ClientOnly>
                          ...
                          <div class="d-flex align-center gap-x-3">
                            ...
                            <div>
                              ...
                              <div class="text-body-2 text-disabled d-none">
                                {{ data.position }}
                              </div>
                            </div>
                          </div>
