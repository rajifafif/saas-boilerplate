...
const faqData = [
  ...
  },
  {
    ...
    answer: 'A regular license can be used for one client workspace that does not charge end users for access. If you want to serve multiple clients or paid SaaS subscriptions, choose the license tier that matches that rollout.',
  },
  {
