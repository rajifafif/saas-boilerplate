        ...
        <VRow>
          ...
          >
            ...
            >
              ...
              >
              Greenwich Business Park, Jl. Bumi Botanika No.E19, Lengkong Kulon, Pagedangan, Tangerang Regency, Banten 15331

              <div class="d-flex gap-4 mt-4">
                <VIcon icon="tabler-map" />
                <a href="https://maps.app.goo.gl/Hxd2KxZUUduiS6vp7" target="_blank">View In Google Map</a>
              </div>
              </div>
            </div>
          </VCol>
          ...
          >
            ...
            >
              ...
              <a href="https://rajaa.ai" target="_blank" rel="noopener noreferrer">
                <VIcon icon="tabler-brand-instagram" />
                <span class="text-white">RAJAA SaaS Boilerplate</span>
              </a>
            </div>
          </VCol>
